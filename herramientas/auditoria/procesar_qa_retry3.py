"""
procesar_qa_retry3.py
------------------------
Aplica el resultado del QA visual de los 73 candidatos del reintento 3
(12 dominios, incluye tudrogueriavirtual.com): "ok" -> registra en
productos.json y marca "corregida"; "sospechosa" -> mueve el archivo a
...
resultados = {}
for nombre_archivo in ("qa_retry3_a.txt", "qa_retry3_b.txt", "qa_retry3_c.txt"):
...
print(f"Total resultados QA retry3: {len(resultados)}")
...
for fila in filas:
    ...
    if sku in ok_ids:
        ...
        nota = "Fase 2 reintento 3 (12 fuentes, incl. Tu Drogueria Virtual): confirmada por QA visual"
        ...
        nota = "Fase 2 reintento 3 (12 fuentes): candidato encontrado pero sigue sin coincidir tras QA visual - agotadas las fuentes permitidas disponibles"
        fila["notas"] = f"{fila['notas']}; {nota}" if fila["notas"] else nota
